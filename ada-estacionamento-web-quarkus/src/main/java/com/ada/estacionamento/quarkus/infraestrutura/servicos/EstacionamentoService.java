package com.ada.estacionamento.quarkus.infraestrutura.servicos;

import com.ada.estacionamento.quarkus.dominio.Estacionamento;
import com.ada.estacionamento.quarkus.dominio.Registro;
import com.ada.estacionamento.quarkus.dominio.veiculos.VeiculoTipo;
import com.ada.estacionamento.quarkus.infraestrutura.repositorios.EstacionamentoRepository;
import com.ada.estacionamento.quarkus.infraestrutura.repositorios.RegistroRepository;
...
public class EstacionamentoService {
    ...
    public void iniciar(int capacidade) {
        ...
        estacionamentoRepository.persist(entity);
    ...
    public void atualizar(int capacidade) {
        ...
        estacionamentoRepository.persist(estacionamentoEntity);
    }
    ...
    public Registro registrarPlaca(String placa, String veiculoTipo) {
        ...
        registroRepository.persist(registroEntity);
