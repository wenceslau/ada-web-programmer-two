...
import br.com.ada.springsecurityjwt.config.jwt.JWTAuthenticationFilter;
import br.com.ada.springsecurityjwt.config.jwt.JWTAuthorizationFilter;
...
public class SecurityConfig {
    ...
    private static final RequestMatcher[] PUBLIC = {
            AntPathRequestMatcher.antMatcher(HttpMethod.GET, "/helloPublic"),
    };
